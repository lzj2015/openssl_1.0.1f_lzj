...
OPENSSL_CMD=../openssl-1.0.1f/apps/openssl
...
if [ $1 == 1 ]
then
    TEST_CA_DN="//C=CN\ST=BJ\L=GUANGZHOU\O=LZJ Technology LTD.\OU=SORB of openssl\CN=Test CA (SM2)"
    TEST_SERVER_DN="//C=CN\ST=BJ\L=GUANGZHOU\O=LZJ Technology LTD.\OU=BSRC of openssl\CN=server sign (SM2)"
    TEST_SERVER_ENC_DN="//C=CN\ST=BJ\L=GUANGZHOU\O=LZJ Technology LTD.\OU=BSRC of openssl\CN=server enc (SM2)"
    TEST_CLIENT_DN="//C=CN\ST=BJ\L=GUANGZHOU\O=LZJ Technology LTD.\OU=BSRC of openssl\CN=client sign (SM2)"
    TEST_CLIENT_ENC_DN="//C=CN\ST=BJ\L=GUANGZHOU\O=LZJ Technology LTD.\OU=BSRC of openssl\CN=client sign (SM2)"
else
    TEST_CA_DN="/C=CN/ST=BJ/L=GUANGZHOU/O=LZJ Technology LTD./OU=SORB of openssl/CN=Test CA (SM2)"
    TEST_SERVER_DN="/C=CN/ST=BJ/L=GUANGZHOU/O=LZJ Technology LTD./OU=BSRC of openssl/CN=server sign (SM2)"
    TEST_SERVER_ENC_DN="/C=CN/ST=BJ/L=GUANGZHOU/O=LZJ Technology LTD./OU=BSRC of openssl/CN=server enc (SM2)"
