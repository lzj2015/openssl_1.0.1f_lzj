...
DIRS=   crypto ssl engines apps test tools sm2ssltest
ENGDIRS= ccgost
...
sub_all: build_all
build_all: build_libs build_apps build_tests build_tools build_sm2ssltests
...
build_sm2ssltests:
	@dir=sm2ssltest; target=all; $(BUILD_ONE_CMD)
